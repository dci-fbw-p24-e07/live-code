...
class Musician(ValidatedModel):
    ...
    authors = models.ManyToManyField(Author, through="Member", related_name="members")


class Member(ValidatedModel):
    """Intermediate table between Musician and Author."""
...
class Song(ValidatedModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["title", "album", "duration"],
                                    name="unique_song")
        ]
